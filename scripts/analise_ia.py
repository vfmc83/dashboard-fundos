...
OVERRIDES = {
    ...
    "VGIA11": "Inadimplencia relevante e concentrada: a Cooperativa Languiru, devedora de 3 CRAs que somam ~12% do patrimonio (~R$120 mi), entrou em inadimplemento ao deixar de pagar juros com vencimento em jul/2026, com disputa judicial sobre a validade de uma garantia vinculada a contrato da cooperativa com a JBS. A cota caiu ~25% na semana (negociada abaixo de R$8, com leilao por oscilacao) e os dividendos recuaram (de R$0,15 em mar para R$0,13 em mai-jul/2026); a manutencao do rendimento depende do recebimento dos juros, de eventuais provisoes para perdas e da renegociacao com o devedor. A gestora (Valora) considera a reacao do mercado exagerada. (Noticias e fatos relevantes, jul/2026.)",
}
